...
class ConcreteSubject(Subject):
    """
    El Sujeto posee algún estado importante y notifica a los observers cuando los estados
    cambian
    """
    ...
    def attach(self, observer: Observer) -> None:
        print("Subject: Adjunto un observer.")
    ...
    def notify(self) -> None:
        ...
        print("Asunto: Notificación a las observers ...")
